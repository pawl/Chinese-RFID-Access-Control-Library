...
from rfid import comma_format_to_ten_digit, ten_digit_to_comma_format, RFIDClient
...
class TestRFIDClient(unittest.TestCase):
    ...
    def test_crc_16_ibm(self):
        ...
        test_data = (
            '2010' + RFIDClient.source_port + '2800000000000000' +
            test_controller_serial + '00000200ffffffff'
        )
